 ...
 */
public class MyConsistencyDowngradingRetryPolicy implements RetryPolicy {

  private static final Logger LOG =
      LoggerFactory.getLogger(MyConsistencyDowngradingRetryPolicy.class);
  ...
  public MyConsistencyDowngradingRetryPolicy(
      @NonNull DriverContext context, @NonNull String profileName) {
    this(context.getSessionName() + "|" + profileName);
  }

  public MyConsistencyDowngradingRetryPolicy(@NonNull String logPrefix) {
